...
const OntheMenu = () => {
    ...
    return (
        ...
        <Box padding='40px' bg='white' color='black' maxH="full" maxW='3xl'>
          ...
          <Text fontSize="xl" >Each DawnFood meal is perfectly sized for 1 person to enjoy at 1 sitting. Our fully-prepared meals are delivered fresh, and ready to eat in 3 minutes.</Text>
{/* all items */}
